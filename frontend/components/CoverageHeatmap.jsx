    ...
    <div className="card">
      <div className="card-head">
        ...
        <span className="hm-meta">
          {drugs.length} drugs · {payers.length} payers
        </span>
      </div>
      ...
      <div className="card-body">
        ...
        {loading ? (
          <div className="search-status">Loading heatmap…</div>
        ) : error ? (
          <div className="search-status">{error}</div>
        ) : drugs.length === 0 || payers.length === 0 ? (
          <div className="search-status">No coverage matrix available yet.</div>
        ) : (
